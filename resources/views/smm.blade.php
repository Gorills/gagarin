    ...
    <div class="breadcrumbs">
        <div class="container">
            <ol class="breadcrumbs__inner">
                ...
                <li class="breadcrumbs__item breadcrumbs__item--active">SMM</li>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="section__inner">
                <h1 class="title"><span class="span-accent">SMM</span> (social media marketing) в Томске</h1>
